...
public interface F {
    //真机URL
    public static String SERVIEW_URL = "http://192.168.42.232:8080/FuLiCenterServer/Server?request=";
    //安卓虚拟机URl
     ...
     * 商品排序方式
     */
    public final int PRICE1 = 1;
    public final int PRICE2 = 2;
    public final int TIME1 = 3;
    public final int TIME2 = 4;
    ...
    String DOWNLOAD_ALBUM_IMG_URL = SERVIEW_URL +
            REQUEST_DOWNLOAD_ALBUM_IMG + "&img_url=";
    ...
    String DOWNLOAD_DOWNLOAD_CATEGORY_GROUP_IMAGE_URL = SERVIEW_URL +
            ...
            + "&" + cn.hbm.fulicenter.D.CategoryGroup.IMAGE_URL + "=";
    ...
    String DOWNLOAD_DOWNLOAD_CATEGORY_CHILD_IMAGE_URL = SERVIEW_URL +
            "?request=" + REQUEST_DOWNLOAD_CATEGORY_GROUP_IMAGE
            + "&" + cn.hbm.fulicenter.D.CategoryChild.IMAGE_URL + "=";
