package cn.hbm.fulicenter.hxim.db;
...
import cn.hbm.fulicenter.hxim.domain.InviteMessage;
import cn.hbm.fulicenter.hxim.domain.InviteMessage.InviteMesageStatus;
...
public class DemoDBManager {
    ...
    public void saveSuperData(UserAvatar user) {
        ...
        values.put(UserDao.SUPER_NAME_NICK, user.getMUserNick());
        values.put(UserDao.SUPER_NAME_AVATAR, user.getMAvatarId());
        values.put(UserDao.SUPER_NAME_AVATAR_PATH, user.getMAvatarPath());
