...
import cn.hbm.fulicenter.task.DowAllFirendListTask;
...
//                        new DowAllFirendListTask(LoginActivity.this).dowAllFirendLsit();
    ...
    private void initializeContacts() {
        Map<String, cn.hbm.fulicenter.domain.User> userlist = new HashMap<String, cn.hbm.fulicenter.domain.User>();
        // 添加user"申请与通知"
        cn.hbm.fulicenter.domain.User newFriends = new cn.hbm.fulicenter.domain.User();
        ...
        // 添加"群聊"
        cn.hbm.fulicenter.domain.User groupUser = new cn.hbm.fulicenter.domain.User();
        ...
        // 添加"Robot"
        cn.hbm.fulicenter.domain.User robotUser = new cn.hbm.fulicenter.domain.User();
        ...
        List<cn.hbm.fulicenter.domain.User> users = new ArrayList<cn.hbm.fulicenter.domain.User>(userlist.values());
