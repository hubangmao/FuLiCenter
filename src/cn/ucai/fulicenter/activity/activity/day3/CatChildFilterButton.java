package cn.ucai.fulicenter.activity.activity.day3;
...
public class CatChildFilterButton extends Button {
    ...
    class CatFilterAdapter extends BaseAdapter {
        ...
        public View getView(int position, View layout, final ViewGroup parent) {
            ...
            String url = F.SERVIEW_URL + F.REQUEST_DOWNLOAD_CATEGORY_CHILD_IMAGE + "&" + F.Boutique.IMAGE_URL + "=" + imgUrl;
            UserUtils.setImage(context, holder.ivThumb, url);
            ...
            holder.layoutItem.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra(F.CategoryChild.CAT_ID, child.getId());
                    intent.putExtra("childList", Children);
                    intent.putExtra(F.CategoryGroup.NAME, mbtnTop.getText().toString());
                    mContext.startActivity(intent);
                    ((CategoryInfoActivity) mContext).finish();
                }
            });
            return layout;
        }
