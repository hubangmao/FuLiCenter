 ...
 */
package cn.ucai.fulicenter.hxim.db;
...
public class DbOpenHelper extends SQLiteOpenHelper {
    ...
    //SuperWeChat 创建数据库 sql语句
    private static final String SUPERWECHAT_SQL_TABLE_CREATE = "CREATE TABLE "
            + UserDao.SUPER_TABLE_NAME + " ("
            + UserDao.SUPER_USER_ID+" TEXT PRIMARY KEY, "
            + UserDao.SUPER_NAME_NICK+ " TEXT, "
            + UserDao.SUPER_NAME_AVATAR+ " INTEGER, "
            + UserDao.SUPER_NAME_AVATAR_TYPE + " INTEGER, "
            + UserDao.SUPER_NAME_AVATAR_PATH+ " TEXT, "
            + UserDao.SUPER_NAME_AVATAR_TIME + " TEXT); ";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //创建sql文件
        db.execSQL(SUPERWECHAT_SQL_TABLE_CREATE);
