 ...
 */
package cn.ucai.fulicenter.hxim.super_activity;
...
//                        new DowAllFirendListTask(LoginActivity.this).dowAllFirendLsit();
    ...
    private void initializeContacts() {
        Map<String, cn.ucai.fulicenter.hxim.domain.User> userlist = new HashMap<String, cn.ucai.fulicenter.hxim.domain.User>();
        // 添加user"申请与通知"
        cn.ucai.fulicenter.hxim.domain.User newFriends = new cn.ucai.fulicenter.hxim.domain.User();
        ...
        // 添加"群聊"
        cn.ucai.fulicenter.hxim.domain.User groupUser = new cn.ucai.fulicenter.hxim.domain.User();
        ...
        // 添加"Robot"
        cn.ucai.fulicenter.hxim.domain.User robotUser = new cn.ucai.fulicenter.hxim.domain.User();
        ...
        List<cn.ucai.fulicenter.hxim.domain.User> users = new ArrayList<cn.ucai.fulicenter.hxim.domain.User>(userlist.values());
